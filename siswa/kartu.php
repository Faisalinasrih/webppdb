            ...
            <div class="p-3">
	            <div class="card mb-2 mt-2 py-3 border-bottom-success">
                    <div class="card-body">
	            		...
	            		<p class="h5 mb-2 mt-2 text-gray-800 text-center font-weight-bold">FAISAL INASRI HIDAYAT</p>
	            		<p class="h6 mb-2 mt-2 text-gray-800 text-center">NISN</p>
	            		<p class="h5 mb-2 mt-2 text-gray-800 text-center font-weight-bold">123456789</p>
		        	</div>
		        	<div class="col" style="text-align: center;">
		        				<div class="my-2"></div>
                                    <a href="cetakkartu.php" class="btn btn-success btn-icon-split">
